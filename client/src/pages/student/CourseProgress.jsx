    ...
    <div className='max-w-7xl mx-auto p-4 mt-20'>
      ...
      <div className='flex flex-col md:flex-row gap-6'>
        ...
        <div className='flex-1 md:w-3/5 h-fit rounded-lg  shadow-lg p-4'>
          ...
          <div className='mt-2'>
            <h1 className='font-medium text-lg'>Lecture 1 : Introduction</h1>
          </div>
        </div>
        {/* Lecture Sidebar */}
                ...
                <Card key={idx} className="mb-3 hover:cursor-pointer transition transform">
                  <CardContent className="flex items-center justify-between p-4">
                    <div className='flex items-center'>
                        {
                          isCompleted ? (<CheckCircle2 size={24} className='text-green-500 mr-2 '/>) : (<CirclePlay size={24} className='mr-2 '/> )
                        }
                        <div>
