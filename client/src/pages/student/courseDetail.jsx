    ...
    <div  className='mt-20 space-y-4'>
        <div className='bg-gradient-to-r from-zinc-900 to-zinc-600 text-neutral-200'>
            <div className='max-w-7xl mx-auto py-8 px-4 md:px-8 flex flex-col gap-2'>
                ...
                <p>created by {" "} <span className='text-neutral-400 italic underline'>{course.creator.name} </span></p>
                <div className='flex items-center gap-2 text-sm text-neutral-300'>
                    <BadgeInfo size={16} />
                    <p>Last updated - {course.createdAt.split("T")[0]}</p>
                </div>
                <p className='text-neutral-300 text-sm'>Students Enrolled  : {course.enrolledStudents.length} </p>
            </div>
        </div>
